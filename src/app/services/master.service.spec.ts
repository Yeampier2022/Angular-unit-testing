...
describe('MasterService', () => {
  ...
  let valueServcieSpy: jasmine.SpyObj<ValueService>

  beforeEach(() => {
    const spy = jasmine.createSpyObj('valueSerice', ['getValue'])
    ...
    valueServcieSpy = TestBed.inject(ValueService) as jasmine.SpyObj<ValueService>
  ...
  it('should call to getValue from ValueService', () => {
    const valueServiceSpy = jasmine.createSpyObj('ValueSerice', ['getValue']);
